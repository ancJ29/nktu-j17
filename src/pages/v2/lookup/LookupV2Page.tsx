    ...
    <DesktopOnlyGuard>
      <Stack gap="lg">
        ...
        <Modal
          ...
          title={
            isEditing
              ? `${t('common.actions.edit')} — ${t(registered.labelKey as never)}`
            ...
            >
              <Group gap="xs">
                {editing && canEdit && (
                  ...
                  >
                    {editing.isActive ? t('common.actions.disable') : t('common.actions.enable')}
                  </Button>
                )}
                {editing && canDelete && (
                  <Button
              ...
              <Group justify="flex-end" gap="sm">
                ...
                <Button type="submit" loading={submitting}>
                  {isEditing ? t('common.actions.edit') : t('lookups.addItem')}
                </Button>
              </Group>
            </Group>
          </Form>
