...
type MaterialBulkImportFormProps = {
  readonly isLoading: boolean;
  readonly isDownloading: boolean;
  readonly file?: File;
  readonly importResult?: MaterialImportResult;
...
export function MaterialBulkImportForm({
  isLoading,
  isDownloading,
  file,
  importResult,
          ...
          <Group>
            ...
            <div>
              ...
              <Text size="sm" c="dimmed">
                {t('materials.bulkImport.sampleDescription')}
              </Text>
            </div>
          </Group>
          <Button
      ...
      <Paper withBorder shadow="sm" p="lg" radius="md">
        <Stack gap="md">
          <Group>
            ...
            <div>
              <Text fw={500} size="lg">
                {t('materials.bulkImport.uploadFile')}
              </Text>
              <Text size="sm" c="dimmed">
          ...
          {importResult ? (
            <>
              ...
              <Stack gap="sm">
                ...
                />
                <Group justify="space-between">
                  <Badge color="blue" variant="light" leftSection={<IconBox size={14} />}>
                ...
                {importResult.skipped && importResult.skipped.length > 0 ? (
                  <Stack gap={4}>
                    <Text fw={500} size="sm" c="orange.7">
                      {t('materials.bulkImport.skippedTitle')}
                    </Text>
